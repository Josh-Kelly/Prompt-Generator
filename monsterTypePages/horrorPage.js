...
function rollNature() {
    const horrorNatureRand = Math.floor(Math.random()*horrorNatureArray.length);
    const horrorNature = horrorNatureArray[horrorNatureRand];

    document.getElementById('horrorNatureText').innerText = '';
    document.getElementById('horrorNatureText').innerText = `${horrorNature}`;
}

function rollIntellect() {
    const horrorIntellectRand = Math.floor(Math.random()*horrorIntellectArray.length);
    const horrorIntellect = horrorIntellectArray[horrorIntellectRand];

    document.getElementById('horrorIntellectText').innerText = '';
    document.getElementById('horrorIntellectText').innerText = `${horrorIntellect}`;
}
...
function rollBasicForm() {
    ...
    document.getElementById('basicFormText').innerText = `${horrorBasicForm}`;
}

function rollAttribute() {
    const horrorAttributesRand = Math.floor(Math.random()*horrorAttributesArray.length)
    const horrorAttributes = horrorAttributesArray[horrorAttributesRand];

    document.getElementById('attributeText').innerText = '';
    document.getElementById('attributeText').innerText = `${horrorAttributes}`;
}

function rollSkin() {
    const horrorSkinRand = Math.floor(Math.random()*horrorSkinArray.length)
    const horrorSkin = horrorSkinArray[horrorSkinRand];

    document.getElementById('skinText').innerText = '';
    document.getElementById('skinText').innerText = `${horrorSkin}`;
}
function rollOtherFeature() {
    const horrorOtherFeatureRand = Math.floor(Math.random()*horrorOtherFeatureArray.length)
    const horrorOtherFeature = horrorOtherFeatureArray[horrorOtherFeatureRand];

    document.getElementById('otherFeatureText').innerText = '';
    document.getElementById('otherFeatureText').innerText = `${horrorOtherFeature}`;
}

function rollChitinPattern() {
    const chitinColorRand = Math.floor(Math.random()*chitinColorArray.length);
    const chitinColor = chitinColorArray[chitinColorRand];

    document.getElementById('chitinColorPatternText').innerText = '';
    document.getElementById('chitinColorPatternText').innerText = `${chitinColor}`;
}

function rollChitinTexture() {
    const chitinTextureRand = Math.floor(Math.random()*chitinTextureArray.length);
    const chitinTexture = chitinTextureArray[chitinTextureRand];

    document.getElementById('chitinTextureText').innerText = '';
    document.getElementById('chitinTextureText').innerText = `${chitinTexture}`;
}

function rollSpecialAttacks() { /* I've arbitrarily decided that the creature should have 1-3 special attacks. The min and max number can be adjusted below */
...
function rollSpecialDefenses() { /* I've arbitrarily decided that the creature should have 1-3 special defenses. The min and max number can be adjusted below */
...
/* weighted by adding horrorNature0130 3 times */
const horrorNature0130 = 'horror out of the dark subterranean reaches where water drips in fetid pools of darkness and where mankind is not meant to delve';
const horrorNature3140 = 'ancient horror that yet survives from the primordial times before the dawn of man, the dawn of history, and the dawn of sanity';
...
const horrorNatureArray = [horrorNature0130, horrorNature0130, horrorNature0130, horrorNature3140, horrorNature4150, horrorNature5160, horrorNature6170, horrorNature7180, horrorNature8190, horrorNature91100];


/* weighted by adding horrorIntellect0130 3 times */
...
const horrorIntellectArray = [horrorIntellect0130, horrorIntellect0130, horrorIntellect0130, horrorIntellect3140, horrorIntellect4150, horrorIntellect5160, horrorIntellect6170, horrorIntellect7180, horrorIntellect8190, horrorIntellect91100];
...
const horrorAttributesArray = [ horrorAttributes0105,  horrorAttributes0610,  horrorAttributes1115,  horrorAttributes1620,  horrorAttributes2125,  horrorAttributes2630,  horrorAttributes3135,  horrorAttributes3640,  horrorAttributes4145,  horrorAttributes4650,  horrorAttributes5155,  horrorAttributes5660,  horrorAttributes6165,  horrorAttributes6670,  horrorAttributes7175,  horrorAttributes7680,  horrorAttributes8185,  horrorAttributes8690,  horrorAttributes9195,  horrorAttributes96100];
...
const horrorSkinArray = [horrorSkin0105, horrorSkin0610, horrorSkin1115, horrorSkin1620, horrorSkin2125, horrorSkin2630, horrorSkin3135, horrorSkin3640, horrorSkin4145, horrorSkin4650, horrorSkin5155, horrorSkin5660, horrorSkin6165, horrorSkin6670, horrorSkin7175, horrorSkin7680, horrorSkin8185, horrorSkin8690, horrorSkin9195, horrorSkin96100];


const horrorOtherFeature0105 = 'blow-holes';
const horrorOtherFeature0610 = 'eats abstract food (Table 2-5)';
const horrorOtherFeature1115 = 'entire creature is disembodied head of some animal type with other bizarre features (possibly huge)';
...
const horrorOtherFeatureArray = [horrorOtherFeature0105, horrorOtherFeature0610, horrorOtherFeature1115, horrorOtherFeature1620, horrorOtherFeature2125, horrorOtherFeature2630, horrorOtherFeature3135, horrorOtherFeature3640, horrorOtherFeature4145, horrorOtherFeature4650, horrorOtherFeature5155, horrorOtherFeature5660, horrorOtherFeature6165, horrorOtherFeature6670, horrorOtherFeature7175, horrorOtherFeature7680, horrorOtherFeature8185, horrorOtherFeature8690, horrorOtherFeature9195, horrorOtherFeature96100];


const chitinColorArray = ['black', 'blue', 'brown', 'diamond pattern', 'green', 'grey', 'moving patterns', 'one color for front, different for back', 'one color for top, another for bottom', 'orange', 'pink', 'purple', 'red', 'reflective', 'splotchy pattern', 'spotted', 'striped', 'white', 'whorled patterns', 'yellow'];


const chitinTextureArray = ['barbed', 'basically smooth', 'bumpy', 'coral-like protrusions', 'curved, thorn-like protrusions', 'engraved with blasphemous runes', 'extremely smooth; color of chitin becomes iridescent as a result', 'flexible but as hard as normal chitin/armor', 'highly regular pattern of protrusions (bumps or small pyramidal shapes) which looks almost factory-generated', 'irregular patterns or patches of stiff hair grows from carapace', 'pitted, irregular grooves and cuts', 'ridged (possibly sharp)', 'smooth', 'spiked (long spikes)', 'spiked (short spikes)', 'sticky', 'very smooth (but not to the point of iridescence)', 'wavy surface texture', 'waxy; not nearly as touch as it looks', 'whorled texture, almost patterns'];
